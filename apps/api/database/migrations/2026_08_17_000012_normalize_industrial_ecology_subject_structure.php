...
return new class extends Migration
{
    ...
    private function normalizeSubjects(array $sections): array
    {
        foreach ($sections as $index => $section) {
            ...
            $sections[$index] = [
                ...
                'items' => [],
                'bachelor' => $this->splitNumberedItems($text),
                'master' => [],
            ];
    ...
    {
        $text = preg_replace('/\b(Bachelor subjects|Bachelor\'?s?\s+Degree|Bakalavriat fanlari|Дисциплины бакалавриата|مواد البكالوريوس)\s*:?/iu', '', $text);
