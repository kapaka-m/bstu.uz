...
const RESOURCE_SCHEMAS = {
  ...
  "green-campus-stats": {
    ...
    fields: [
      { name: "icon", label: "Lucide Icon Code", type: "text" },
      { name: "sort_order", label: "Sort index rank", type: "number" },
      {
        name: "value",
        label: "Metric Value",
        type: "text",
  ...
  "green-campus-articles": {
    ...
    fields: [
      { name: "slug", label: "Slug URL Link", type: "text", required: true },
      { name: "image", label: "Featured cover Image", type: "media" },
      ...
      {
        name: "content",
        label: "Description content details",
        type: "textarea",
        required: true,
        translated: true,
      },
