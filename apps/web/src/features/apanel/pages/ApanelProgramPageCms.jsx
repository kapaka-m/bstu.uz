    ...
    <form onSubmit={save} className="space-y-6">
      <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
        ...
        <h1 className="mt-2 text-2xl font-black uppercase tracking-wide text-navy">
          {t("interface.programPages")}
        </h1>
        <p className="mt-2 text-sm font-semibold text-gray-500">
          {t("interface.programLabelsHelp")}
        </p>
      </div>
      ...
      <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
        <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h2 className="text-xl font-black text-navy">{t("interface.sharedProgramLabels")}</h2>
            <p className="mt-1 text-xs font-bold text-gray-400">
              {t("interface.programLabelsScope")}
            </p>
          </div>
