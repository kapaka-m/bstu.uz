        ...
        >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative flex items-center">
              <User className="absolute left-4 rtl:left-auto rtl:right-4 w-4 h-4 text-gray-400" />
              <input
                type="text"
                id="name"
                ...
                className="w-full bg-white border border-gray-100 hover:border-gray-200 focus:border-primary pl-11 pr-4 rtl:pl-4 rtl:pr-11 py-3 rounded-xl text-sm focus:outline-none transition-all shadow-sm"
                required
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full bg-white border border-gray-100 hover:border-gray-200 focus:border-primary pl-11 pr-12 rtl:pl-12 rtl:pr-11 py-3 rounded-xl text-sm focus:outline-none transition-all shadow-sm"
                required
              />
              <button
                type="button"
